# Generated by Django 4.2.5 on 2025-08-10 06:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_agendamento', models.CharField(choices=[('AVALIAÇÃO', 'AVALIAÇÃO'), ('PROCEDIMENTO', 'PROCEDIMENTO')], max_length=50, verbose_name='Tipo de Agendamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(blank=True, choices=[('MASCULINO', 'MASCULINO'), ('FEMININO', 'FEMININO'), ('OUTRO', 'OUTRO'), ('NÃO INFORMAR', 'NÃO INFORMAR')], max_length=25, null=True, verbose_name='Gênero')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_tratamento', models.CharField(blank=True, choices=[('Facial', 'Facial'), ('Labial', 'Labial'), ('Glúteos', 'Glúteos'), ('Corporal', 'Corporal')], max_length=100, null=True, verbose_name='Tipo Tratamento')),
                ('duracao', models.DurationField(blank=True, choices=[(datetime.timedelta(seconds=1800), '30 minutos'), (datetime.timedelta(seconds=3600), '1 hora'), (datetime.timedelta(seconds=5400), '1 hora e 30 minutos'), (datetime.timedelta(seconds=7200), '2 horas'), (datetime.timedelta(seconds=9000), '2 horas e 30 minutos'), (datetime.timedelta(seconds=10800), '3 horas'), (datetime.timedelta(seconds=12600), '3 horas e 30 minutos'), (datetime.timedelta(seconds=14400), '4 horas'), (datetime.timedelta(seconds=16200), '4 horas e 30 minutos'), (datetime.timedelta(seconds=18000), '5 horas'), (datetime.timedelta(seconds=19800), '5 horas e 30 minutos'), (datetime.timedelta(seconds=21600), '6 horas'), (datetime.timedelta(seconds=23400), '6 horas e 30 minutos'), (datetime.timedelta(seconds=25200), '7 horas'), (datetime.timedelta(seconds=27000), '7 horas e 30 minutos'), (datetime.timedelta(seconds=28800), '8 horas')], verbose_name='Duração')),
                ('preco', models.DecimalField(blank=True, decimal_places=2, max_digits=10, verbose_name='Preço')),
